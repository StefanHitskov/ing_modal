...
if (isset($_REQUEST['mail_to'])){$to = $_REQUEST['mail_to'];} else {echo 'Oops!mail_settings';die();}
if (isset($_REQUEST['mail_from'])){$from = $_REQUEST['mail_from'];} else {echo 'Oops!mail_settings';die();}
if (isset($_REQUEST['mail_subject'])){$subject = $_REQUEST['mail_subject'];} else {echo 'Oops!mail_settings';die();}
