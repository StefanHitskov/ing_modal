...
//настройки
var modal_selector = '.mform, .green_input, .green_input a, .mform a';
...
var form_code = 
	'<div id="imd_form">'+
		...
		form_code += 
		'<div style="text-align:center;width:100%;padding:1px;"><input type="submit"  value="'+send_text+'" /></div>'+
		'</form>'+
	'</div>';	
...
function show_form(){
	...
	$('#win_frame > #content input[name="tovar"]').val($('.itemview > .rightitem > h3').text());
...
//transparent
	...
	$('#win_frame > #content').css({'padding':'15px'}); 
	...
	$('#content textarea').css({'width':'92%','height':'100px','color':inputs_color,'padding':'10px','font':'14px "Arial"','margin':'5px 0',});
